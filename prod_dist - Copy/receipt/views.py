...
def create_receipt(request):
    ...
    if request.method=='POST':
        ...
        from_address = from_model.address.address
        to_address = to_model.address.address
...
def distributor_products(request,distributor_id):
    ...
    if request.method=='GET':
        ...
        from_address = distributor.address.address
        to_address = retailer.address.address
        products_list = []
        for product in products:
            p = Products(
                prod_name=product['product'],
...
def company_products(request,company_id):
    if request.method=='GET':
        ...
        from_address = company.address.address
        to_address = distributor.address.address
        products_list = []
        for product in products:
            p = Products(
                prod_name=product['product'],
