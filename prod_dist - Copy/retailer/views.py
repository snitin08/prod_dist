...
def retailer_edit(request,retailer_id):
    if request.method=='GET':
        ...
        data = {
            ...
            "state":retailer.address.pincode.city.state,
            "city":retailer.address.pincode.city.city,
            "pincode":retailer.address.pincode.pincode,            
        }
        ...
        try:
            ...
            messages = {}
            print(str(e))
            if str(e)=="UNIQUE constraint failed: mainApp_retailer.address":
